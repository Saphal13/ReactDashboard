...
const App = () => {
  ...
  return (
    // //tailwind is connected checked (in classname val)
            ...
            <div className="flex relative dark:bg-main-dark-bg">
                <div className="fixed right-4 bottom-4" style={{zIndex:'1000'}}>
                    ...
                    <TooltipComponent content="Settings" position="Top">
                        ...
                        //to change Dynamically present as inline
                ...
                <div>
                    ...
                    {/* After creating file structure change each String element into components*/}
